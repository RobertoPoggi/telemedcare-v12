...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div id="stats" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
    ...
    <script>
        ...
        function formatDate(dateStr, includeTime = false) {
            ...
            // Check if dateStr is just a date (YYYY-MM-DD) or has time component
            ...
            // Only include time if explicitly requested AND date string has time component
