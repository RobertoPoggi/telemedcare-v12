    ...
    <script>
        ...
        async function loadDashboardData() {
            try {
                ...
                document.getElementById('contractsSent').textContent = stats.contractsToday || '0';
                document.getElementById('emailsSent').textContent = stats.emailsWeek || '0';
                ...
                // Aggiorna grafici
                updateServicesChart(leads);
                updatePlansChart(leads);
...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function updateServicesBreakdown(leads) {
            const counts = { 'FAMILY': 0, 'PRO': 0, 'PREMIUM': 0 };
            leads.forEach(l => {
                if (counts[l.servizio] !== undefined) counts[l.servizio]++;
            });
        ...
        function updateChannelsBreakdown(leads) {
            // Simulazione - in produzione questi dati verrebbero dal DB
            document.getElementById('channelWeb').textContent = Math.round(leads.length * 0.6);
            document.getElementById('channelEmail').textContent = Math.round(leads.length * 0.2);
            document.getElementById('channelPhone').textContent = Math.round(leads.length * 0.15);
            document.getElementById('channelPartner').textContent = Math.round(leads.length * 0.05);
        }
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                <div class="border-2 border-blue-200 bg-blue-50 p-4 rounded-lg text-center">
                ...
                <div class="border-2 border-purple-200 bg-purple-50 p-4 rounded-lg text-center">
                ...
                <div class="border-2 border-yellow-200 bg-yellow-50 p-4 rounded-lg text-center">
                ...
                <div class="border-2 border-orange-200 bg-orange-50 p-4 rounded-lg text-center">
                ...
                <div class="border-2 border-indigo-200 bg-indigo-50 p-4 rounded-lg text-center">
    ...
    <script>
        ...
        function renderWorkflowTable(leads) {
            ...
            if (leads.length === 0) {
                tbody.innerHTML = \`
                    <tr>
                        <td colspan="7" class="py-8 text-center text-gray-400">Nessun workflow in corso</td>
                    </tr>
                \`;
                return;
            }
