 ...
 */
export async function generateProformaPDF(proformaData: ProformaData): Promise<Buffer> {
  try {
    ...
    yPos = addTextWithWrap(doc, `TOTALE DA FATTURARE: €${proformaData.prezzoPacchetto.toFixed(2)} + IVA 22% = €${totaleConIva.toFixed(2)}`, margin, yPos, contentWidth, 11)
    yPos += 10
