    ...
    <script>
        ...
        async function loadLeadData() {
            ...
            try {
                ...
                if (!lead.cittaRichiedente) fields.push(createField('cittaRichiedente', 'Città', 'text', 'Es. Milano', true));
                ...
                if (!lead.cittaAssistito) fields.push(createField('cittaAssistito', 'Città Assistito', 'text', 'Es. Roma', true));
