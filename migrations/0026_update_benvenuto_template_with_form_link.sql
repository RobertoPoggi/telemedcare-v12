-- Update welcome email template to include configuration form link
...
<div class="cta-box">
<h4 style="color: #16a34a; margin-top: 0; font-size: 20px">📝 PROSSIMO PASSO IMPORTANTE</h4>
<p style="font-size: 16px; margin-bottom: 20px">
Per completare l''attivazione del servizio, compili il <strong>Modulo di Configurazione Personalizzata</strong>.
<br/>Ci vogliono solo 5 minuti!
</p>
<a href="{{LINK_CONFIGURAZIONE}}" class="cta-button" style="color: white">
  ✅ Compila il Modulo di Configurazione
</a>
<p style="font-size: 14px; color: #6b7280; margin-top: 15px">
  Questo modulo ci permetterà di configurare il dispositivo SiDLY in base alle Sue esigenze specifiche.
</p>
</div>
...
<ol>
<li><strong>Compilazione Modulo:</strong> Compili il modulo di configurazione tramite il link sopra</li>
...
<p><strong>E-MAIL:</strong> info@medicagb.it</p>
